...
namespace Pruebalinktic.Backend.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("0001", "faiber", "losada", "flosada@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "faiber.jpg", UserType.Admin);
            await CheckUserAsync("0002", "Mari", "Castillo", "maric@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "MariCastillo.jpg", UserType.User);
